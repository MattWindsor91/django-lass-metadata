"""
The `metadata` module contains many mixins for adding common
patterns, both pertinent to the metadata subsystem and not, to
existing models.

Many of these mixins are abstract models that add in new fields
on existing models; you may need to remove direct inheritance from
